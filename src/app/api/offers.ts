export const offers: Record<string, { title: string; content: string }[]> = {
  en: [
    {
    ...
    },
    {
      ...
      content:
        "Focus on conversation, grammar, and vocabulary to boost your confidence and fluency.",
    },
    {
  ...
  ru: [
    ...
    },
    {
      ...
      content:
        "Сосредоточьтесь на разговоре, грамматике и словарном запасе, чтобы повысить свою уверенность и свободное владение языком.",
    },
    {
      title: "Гибкий график",
      content:
  ...
  fr: [
    ...
    },
    {
      ...
      content:
        "Concentrez-vous sur la conversation, la grammaire et le vocabulaire pour renforcer votre confiance et votre fluidité.",
    },
    {
  ...
  ka: [
    ...
    },
    {
      ...
      content:
        "კონცენტრირდით საუბარზე, გრამატიკასა და ლექსიკაზე, რათა გაზარდოთ თქვენი თავდაჯერებულობა და თავისუფლება.",
    },
    {
