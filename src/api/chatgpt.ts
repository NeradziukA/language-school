    ...
    messages: [
      {
        ...
        Создай 4 задания - выбрать правильный ответ из 4 предложенных, 4 задания - вставить пропущенное слово из 4 предложенных, личные вопросы не задавать, вместо пропущенных слов вставь только ___ и 2 задания перевести на французский с ${localeToLanguage(
          locale.toUpperCase()
